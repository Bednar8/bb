...
export default function Hero() {
	return (
		<div
			className="bg-[linear-gradient(#9d85a4_0%,_#0e0e0e_41%)]
 text-light-gray py-11 relative overflow-hidden lg:pb-0 lg:h-[550px] lg:bg-[linear-gradient(164deg,#0e0e0e_48.02%,#9d85a4_95.2%)]
">
			<div className="lg:relative container h-full">
				<Image
					...
					width={650}
					height={300}
					className="absolute top-[-55px] left-1/2 -translate-x-1/2 max-w-[unset] lg:hidden"
				/>
				<Image
				...
				/>
				<div className="mx-auto  mt-[200px] lg:mt-0 lg:mx-0 lg:w-1/2">
					<DiscountBadge />
