...
export default function Footer() {
	return (
		<footer className="bg-gray flex flex-col items-center justify-between pt-12 pb-9 text-sm lg:items-start">
			<div className="flex flex-col  justify-between w-full mx-auto max-w-6xl text-center px-5 lg:flex-row lg:text-left lg:px-0">
				<div>
			...
			<div className="flex gap-4 mt-12 max-w-6xl mx-auto w-full justify-center lg:justify-start">
